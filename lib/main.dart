...
import 'package:flutter_codebase/config/asyncs.dart';
import 'package:flutter_codebase/config/reducers.dart';
...
void main() async
{
    /*
        ...
        Just add specific enum to array so 
        user can only do the specific orientation.
    */
    ...
    /*
        Setup NavigatorKey & FluroRouter
